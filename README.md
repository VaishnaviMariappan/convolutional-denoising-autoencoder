...
![image](https://github.com/VaishnaviMariappan/convolutional-denoising-autoencoder/assets/94169913/32d305b0-dc4b-444e-b36d-06a606cd33dc)
...
x=layers.Conv2D(4,(5,5),activation='relu',padding='same')(x)
x=layers.UpSampling2D((2,2))(x)
